  ...
  void screenRedirect() async {
    ...
    if (user != null) {
      ...
      if (user.emailVerified) {
        ...
        // If the user's email is verified , navigate to the verifyEmailScreen
...
Future<void> sendPasswordResetEmail(String email) async {
  ...
  /* -----------------------Federated indentity & social sign in--------------------- */
  ...
  // [logout User] -- valid for any authenticaton.
  ...
  //    DELETE USER :  Remove user Auth and Firenbase Accouunt
