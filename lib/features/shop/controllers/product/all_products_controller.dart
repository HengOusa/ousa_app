...
class AllProductsController extends GetxController{
  ...
  void sortProducts(String sortOption){
    ...
    switch(sortOption){
      case 'Name': products.sort((a,b) => a.title.compareTo(b.title));
        break;
      case 'Higher': products.sort((a,b) => b.price.compareTo(a.price)); break;
      case 'Lower Price': products.sort((a,b)=> a.date!.compareTo(b.date!)); break;
      case 'Newest': products.sort((a,b)=> a.date!.compareTo(b.date!)); break;
  ...
  void assignProducts(List<ProductModel> products){
    // asign products to the 'Products list
